...
def ai_move(board):
    pieces = [piece for row in board.board for piece in row if piece != 0 and piece.color == WHITE]
    if not pieces:
        return
    ...
    while True:
        ...
        while not game_over:
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN and player_move:
                    ...
                    if selected:
                        ...
                        if result:
                            player_move = False
                            valid_moves = {}
                            # Ensure AI moves after player move
                            ai_move(board)
                            player_move = True
                        else:
                            selected = None
